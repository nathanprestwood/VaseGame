...
public class AdapterOcurrence {
	...
	public static final DateFormat df = new SimpleDateFormat("EEEE, MMM dd, yyyy",  Locale.ROOT);
	...
	public static Occurrence toOcurrence(Entity e) throws ParseException {
		Occurrence o = new Occurrence();
		o.setOccurrenceId(Long.parseLong(e.getId()));
